...
Shared.RemoveWeaponOnOpenRadio = true
Shared.RemoveWeaponOnTalkingOnRadio = true

-- Command for updating callsign, if you dont want it, set it to nil, or remove the line
Shared.CallsignCommand = "callsign"
